    ...
    def init(self, mode=IN, pull=None):
        ...
        if mode is not None:
            if mode == self.IN:
                ...
                # ADC, DAC only available on Pin 0-5 (X12 Pin 1-6)
...
# on i2c-4 X10 Pin9,Pin10 Not able to connect X12 Pin5,6! How to access these?
# iot2050setup Pins are enabled...
